  ...
  return (
    <div className="space-y-4">
      ...
      <input
        ...
        className="w-full bg-black/40 backdrop-blur-sm rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/50 outline-none focus:bg-black/60 transition-colors"
      />
